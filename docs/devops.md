...
Para instruções de instalação em servidores, veja o [Manual de Deploy VPS](vps-deployment.md). Para saber como gerar os instaladores dos clientes, consulte o [Guia de Compilação de Clientes](client-compilation.md).
